...
- `CLAUDE.md` secrets list (`Anthropic:ApiKey` → `OpenRouter:ApiKey`). (`CLAUDE-REFERENCE.md` was retired on `main` while this work was in flight; its options table lives in `docs/articles/configuration-guide.md`.)
