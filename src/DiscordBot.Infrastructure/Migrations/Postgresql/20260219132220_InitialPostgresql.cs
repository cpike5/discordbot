        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetType = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Timestamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DatabaseAvgQueryTimeMs = table.Column<double>(type: "double precision", nullable: false, defaultValue: 0.0),
                    DatabaseTotalQueries = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    DatabaseSlowQueryCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    WorkingSetMB = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    PrivateMemoryMB = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    HeapSizeMB = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    ...
                    CacheHitRatePercent = table.Column<double>(type: "double precision", nullable: false, defaultValue: 0.0),
                    CacheTotalEntries = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    CacheTotalHits = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    CacheTotalMisses = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThresholdUnit = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    IsEnabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: false, defaultValue: "0"),
                    ...
                    GlobalDisplayName = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageMessageLength = table.Column<double>(type: "double precision", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    GuildId = table.Column<long>(type: "bigint", nullable: false),
                    AudioEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    AutoLeaveTimeoutMinutes = table.Column<int>(type: "integer", nullable: false, defaultValue: 5),
                    QueueEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    MaxDurationSeconds = table.Column<int>(type: "integer", nullable: false, defaultValue: 30),
                    MaxFileSizeBytes = table.Column<long>(type: "bigint", nullable: false, defaultValue: 5242880L),
                    MaxSoundsPerGuild = table.Column<int>(type: "integer", nullable: false, defaultValue: 50),
                    MaxStorageBytes = table.Column<long>(type: "bigint", nullable: false, defaultValue: 104857600L),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    EnableMemberPortal = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    SilentPlayback = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SimplePreset = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicLeaderboardEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    GuildId = table.Column<long>(type: "bigint", nullable: false),
                    TtsEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    DefaultVoice = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, defaultValue: "en-US-JennyNeural"),
                    DefaultSpeed = table.Column<double>(type: "double precision", nullable: false, defaultValue: 1.0),
                    DefaultPitch = table.Column<double>(type: "double precision", nullable: false, defaultValue: 1.0),
                    DefaultVolume = table.Column<double>(type: "double precision", nullable: false, defaultValue: 0.80000000000000004),
                    ...
                    AutoPlayOnSend = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    AnnounceJoinsLeaves = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    SsmlEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    StrictSsmlValidation = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    MaxSsmlComplexity = table.Column<int>(type: "integer", nullable: false, defaultValue: 50),
                    DefaultStyle = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    DefaultStyleDegree = table.Column<double>(type: "double precision", nullable: false, defaultValue: 1.0),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuildId = table.Column<long>(type: "bigint", nullable: false),
                    ChannelId = table.Column<long>(type: "bigint", nullable: false),
                    AccusedUserId = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    CustomMessage = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ScheduledAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    NotificationMessageId = table.Column<long>(type: "bigint", nullable: true),
                    VotingMessageId = table.Column<long>(type: "bigint", nullable: true),
                    ClearedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    VotingStartedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    VotingEndedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    Message = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    TriggerAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextExecutionAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadedById = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WelcomeMessage = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false, defaultValue: ""),
                    IncludeAvatar = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    UseEmbed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    EmbedColor = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscordAvatarUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CacheHit = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuildId = table.Column<long>(type: "bigint", nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    CommandName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCachedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasEmbeds = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrantedVia = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RevokedVia = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedFlaggedEventId = table.Column<Guid>(type: "uuid", nullable: true),
                    ContextMessageId = table.Column<decimal>(type: "numeric(20,0)", nullable: true),
                    ContextChannelId = table.Column<decimal>(type: "numeric(20,0)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RatWatchId = table.Column<Guid>(type: "uuid", nullable: false),
                    GuildId = table.Column<long>(type: "bigint", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    OriginalMessageLink = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RatWatchId = table.Column<Guid>(type: "uuid", nullable: false),
                    VoterUserId = table.Column<long>(type: "bigint", nullable: false),
                    IsGuiltyVote = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    LastRefreshedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    DiscordUserId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuildIconHash = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    IsOwner = table.Column<bool>(type: "boolean", nullable: false),
                    Permissions = table.Column<long>(type: "bigint", nullable: false),
                    CapturedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
