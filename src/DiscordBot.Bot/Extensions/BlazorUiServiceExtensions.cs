...
/// state, guild context resolution). Called from <see cref="BlazorServiceExtensions.AddBlazorWeb"/>,
...
public static class BlazorUiServiceExtensions
{
    ...
    /// toast queue and loading flag; and <see cref="IGuildContextProvider"/> (also scoped - it
