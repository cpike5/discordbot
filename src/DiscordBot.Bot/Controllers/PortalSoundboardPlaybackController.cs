...
/// <summary>
/// Controller for member portal soundboard voice-channel connection and playback
/// control: playing a sound, joining/leaving voice channels, stop, and status.
/// </summary>
[ApiController]
[Route("api/portal/soundboard/{guildId}")]
[Authorize(Policy = "PortalGuildMember")]
public class PortalSoundboardPlaybackController : PortalSoundboardControllerBase
{
