...
public class ModTagService : IModTagService
{
    ...
    {
        return await ServiceActivityHelper.ExecuteAsync<ModTagDto>(
            "mod_tag", "create_tag",
            async _ =>
            {
    ...
    {
        return await ServiceActivityHelper.ExecuteAsync<IEnumerable<ModTagDto>>(
            "mod_tag", "get_guild_tags",
            async activity =>
            {
    ...
    {
        return await ServiceActivityHelper.ExecuteAsync<UserModTagDto?>(
            "mod_tag", "apply_tag",
            async _ =>
            {
    ...
    {
        return await ServiceActivityHelper.ExecuteAsync<IEnumerable<UserModTagDto>>(
            "mod_tag", "get_user_tags",
            async activity =>
            {
