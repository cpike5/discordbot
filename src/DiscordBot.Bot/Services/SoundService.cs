...
public class SoundService : ISoundService
{
    ...
    {
        return await ServiceActivityHelper.ExecuteAsync<IReadOnlyList<Sound>>(
            "sound", "get_all_by_guild",
            async activity =>
            {
    ...
    {
        return await ServiceActivityHelper.ExecuteAsync<bool>(
            "sound", "validate_sound_count_limit",
            async _ =>
            {
    ...
    {
        return await ServiceActivityHelper.ExecuteAsync<long>(
            "sound", "get_storage_used",
            async _ =>
            {
