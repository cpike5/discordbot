...
/// <summary>
/// View model for displaying command log details in a modal.
/// </summary>
public record CommandLogDetailsModalViewModel
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the full command text (with slash prefix).
    /// </summary>
    public string FullCommandText => $"/{CommandName}";
    ...
    /// <summary>
    /// Creates a <see cref="CommandLogDetailsModalViewModel"/> from a <see cref="CommandLogDto"/>.
    /// </summary>
    public static CommandLogDetailsModalViewModel FromDto(CommandLogDto dto)
    {
        ...
        return new CommandLogDetailsModalViewModel
        {
            Id = dto.Id,
            GuildId = dto.GuildId,
