...
/// <summary>
/// Configuration options for message log data retention and cleanup policies.
/// </summary>
public class MessageLogRetentionOptions
{
    /// <summary>
    /// Gets or sets the number of days to retain message logs before cleanup.
    /// Default is 90 days.
    /// </summary>
