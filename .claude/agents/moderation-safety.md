...
### Controllers
- `ModerationCasesController`, `ModerationConfigController`, `ModTagsController`, `FlaggedEventsController`, `BulkPurgeController`
...
- `Guilds/FlaggedEvents/` (Index, Details), `Guilds/ModerationSettings/Index.cshtml`, `Admin/BulkPurge.cshtml`
